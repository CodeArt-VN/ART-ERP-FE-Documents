...
- **Tổng số directives**: 6 directives
- **Đã document**: 6 directives  
...
### **🔧 Utility Directives (1 directive)**
- **[ShareDirectives Module](./share-directives-module.md)** - Module exports cho shared directives
